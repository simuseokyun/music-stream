...
import { deviceInfo, nowSongInfo, playerPrevAndNext } from '../../store/atoms';
import { useEffect, useRef, useState } from 'react';
import { getLocalStorage } from '../../utils/getLocalStorage';
import { setLocalStorage } from '../../utils/setLocalStorage';
import { getSdkTokenWithRefreshToken } from '../../api/getSdkTokenWithRefreshToken';
import { useToggleMusic } from '../../hooks/useToggleMusic';
...
export const Player = () => {
    ...
    const { play, pause } = useToggleMusic();
        ...
        const checkTokenValidity = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    const newTokenData = await getSdkTokenWithRefreshToken();
            ...
            <Container $song={song.title ?? null}>
                <PlayerWrap>
                    <PlayerForm>
                        ...
                        <PlayerCenter>
                            <PrevBtn src="/assets/prevButton.png" alt="Prev" onClick={prev} />
                            {song.is_playing ? (
                                <StopBtn src="/assets/stopButton.png" alt="정지" onClick={pause} />
                            ) : (
                                <PlayBtn src="/assets/playButtonInPlayer.png" alt="재생" onClick={play} />
                            )}
                            <NextBtn src="/assets/nextButton.png" alt="Next" onClick={next} />
                        </PlayerCenter>
