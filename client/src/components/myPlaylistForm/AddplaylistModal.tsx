...
import { CloseBtn, Container, Form } from '../../styles/common.style';
        ...
        addPlaylist((prev) => {
            ...
            if (isDuplicate) {
                ...
                const newPlaylist = {
                    ...
                    cover: imagePreview ?? '/assets/playlist.svg',
                    tracks: [],
                };
                setDupState(false);
                ...
                <form onSubmit={handleSubmit(onValid)}>
                    <div className="flex justify-between items-start">
                        <div>
                            <div className="relative w-[100px] h-[100px] overflow-hidden rounded-[8px] left-1/2 -translate-x-1/2">
                                <img
                                    ...
                                    src={imagePreview ?? '/assets/playlist.svg'}
                                    alt="Preview"
                                ></img>
                                <div
                        ...
                        <div className="w-full ml-[20px]">
                            ...
                            {errors.title && <p className="text-sm mt-2 text-accent">{errors.title.message}</p>}
                        </div>
                    </div>
